      ...
      <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <form className="flex max-w-sm border-b border-gold/30">
                ...
                <input
                  ...
                  className="bg-transparent flex-1 py-3 font-body text-sm text-bone outline-none"
                />


                <button
                  type="submit"
                  className="font-body text-xs text-gold px-2"
                >
                  عضویت
                </button>
        ...
        <div className="mt-20 pt-8 border-t border-gold/10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              href="/contact"
              className="font-body text-xs text-bone-faint"
            >
              حریم خصوصی
            </Link>
